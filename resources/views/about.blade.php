...
@section('content')
            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">من نحن</h3>
    ...
    <!-- about area start -->
    <section class="about__area pt-120 pb-20">
        <div class="container">
            <div class="row">
    ...
    <section class="testimonial__area pt-100 pb-150">
        <div class="container">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-10 ">
                    <div class="testimonial__slider-3 text-dark">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial__nav-thumb">
                                        <img src="{{asset('assets/img/events/oussama-kaci.jpg')}}" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial__nav-thumb">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-10">
                    <div class="testimonial__video ml-70 fix ">
                        ...
                        <div class="testimonial__video-content d-sm-flex my-4">
                            <div class="testimonial__video-icon  mb-20">
                              <span>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                    <div class="why__thumb" style="max-width: 90vw">
            ...
            <div class="row ">
                <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
                    <div class="section__title-wrapper text-center mb-60">
                        <h2 class="section__title">نحن نفتخر بما  <span class="yellow-bg yellow-bg-big">نقدمه<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                        <p>نفتخر بما نقدمه من اداء ...</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item mb-30 text-center">
                        ...
                        <div class="counter__content">
                            <h4><span data-purecounter-duration="1" data-purecounter-end="2421" class="purecounter">0</span></h4>
                            <p>عدد الطلاب</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item counter__pl-80 mb-30 text-center">
                        ...
                        <div class="counter__content">
                            <h4><span data-purecounter-duration="1" data-purecounter-end="4" class="purecounter">0</span></h4>
                            <p>عدد الدروس </p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-6  col-sm-6 ">
                    <div class="counter__item counter__pl-34 mb-30 text-center">
                        ...
                        <div class="counter__content">
                            <h4><span data-purecounter-duration="1" data-purecounter-end="6085" class="purecounter">0</span></h4>
                            <p>عدد المتخرجين</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-2 offset-xxl-1 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item mb-30 text-center">
                        ...
                        <div class="counter__content">
                            <h4><span data-purecounter-duration="1" data-purecounter-end="203" class="purecounter">0</span></h4>
                            <p>طلاب نحو العالم</p>
                        </div>
                    </div>
                </div>
